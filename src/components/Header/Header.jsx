    ...
    <header>
      <div className="container">
        <h1 className="logo">
          <Link to={"/"}>
            <img
              src="https://res.cloudinary.com/daten/image/upload/v1650878482/journey_horizon_mb4dlp.png"
              alt="journey horizon logo"
            />
          </Link>
        </h1>
        <nav>
          <ul>
            <li>
              <Link className="nav__item" to={"/"}>
                ...
                >
                  <path
                    d="M16.0705 21.8931H19.8965C20.0353 21.8931 20.1516 21.7758 20.1516 21.638V11.6903C20.1516 11.1271 20.6097 10.6701 21.1719 10.6701H23.039L12.5169 1.55592L1.96209 10.6701H3.82715C4.39035 10.6701 4.84743 11.1271 4.84743 11.6903V21.638C4.84743 21.7758 4.96476 21.8931 5.1025 21.8931H8.92854V15.5164C8.92854 14.8134 9.50092 14.241 10.2039 14.241H14.7951C15.4981 14.241 16.0705 14.8134 16.0705 15.5164V21.8931ZM19.8965 23.4235H15.5603C14.9971 23.4235 14.5401 22.9664 14.5401 22.4032V16.1265C14.5401 15.9306 14.3809 15.7714 14.185 15.7714H10.814C10.6181 15.7714 10.459 15.9306 10.459 16.1265V22.4032C10.459 22.9664 10.0019 23.4235 9.43868 23.4235H5.1025C4.11691 23.4235 3.31702 22.6236 3.31702 21.638V12.2005H1.34686C0.834681 12.2005 0.336786 11.9311 0.121507 11.4659C-0.121319 10.9415 0.00825649 10.3425 0.434732 9.96709L11.4803 0.398928C11.7323 0.157123 12.0996 0.00612166 12.4883 0C12.8995 0.00612166 13.2678 0.157123 13.5473 0.424435L24.5602 9.96301C24.5622 9.96505 24.5633 9.96607 24.5643 9.96709C24.9918 10.3425 25.1214 10.9415 24.8785 11.4659C24.6622 11.9311 24.1654 12.2005 23.6522 12.2005H21.682V21.638C21.682 22.6236 20.8831 23.4235 19.8965 23.4235Z"
                    fill="black"
                  />
                </svg>
              </Link>
              ...
              <>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="topbar__element">Logout</span>
                  </Link>
                </li>
              </>
            ) : (
              <li>
                <Link className="nav__item" to={"/authentication"}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
